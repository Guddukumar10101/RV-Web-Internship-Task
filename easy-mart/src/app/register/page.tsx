...
const loopTexts = [
  "Join Easy Mart and Start Saving",
  "Track Prices Across All Stores",
  "Create Account for Smart Grocery Shopping",
    ...
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <Card className="shadow-xl border border-border rounded-2xl backdrop-blur-xl bg-gradient-to-br from-[oklch(88%_0.1_140)] to-[oklch(78%_0.09_100)] dark:from-[oklch(35%_0.14_140)] dark:to-[oklch(25%_0.12_100)] transition-all">
            <CardHeader>
              <CardTitle className="text-3xl font-bold text-center gradient-text">
                Register at Easy Mart
              </CardTitle>
            </CardHeader>
              ...
              <form className="space-y-5">
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="mt-1 border-[1px] border-[oklch(70%_0.06_120)] dark:border-[oklch(50%_0.08_130)] focus:ring-2 focus:ring-[oklch(68%_0.14_120)] dark:focus:ring-[oklch(60%_0.14_130)] transition"
                  />
                </div>
